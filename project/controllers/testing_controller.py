...
class TestingController:
    ...
    def calibrate(self):
        ...
        for i in range(1,2):
            image = cv.imread(f"../assets/photos/photo{i}.jpg")
            gray = image_module.process_image(image)
            ...
            if ref:
                ...
                imgpoints = np.append(imgpoints, corners)
                ...
                ref, self.mtx, self.dist, rvecs, tvecs = cv.calibrateCamera(objpoints, imgpoints, gray.shape[::-1], None, None)